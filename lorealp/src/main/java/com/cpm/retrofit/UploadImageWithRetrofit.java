...
import com.example.deepakp.customcamera.constant.AlertandMessages;
...
public class UploadImageWithRetrofit  {
    ...
    public UploadImageWithRetrofit(Context context, GSKDatabase db, ProgressDialog pd, int from) {
        this.context = context;
        this.db = db;
        this.pd = pd;
