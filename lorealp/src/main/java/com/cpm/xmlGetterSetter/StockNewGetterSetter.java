...
public class StockNewGetterSetter {
    ...
    public void setCatstock(String catstock) {
        this.catstock = catstock;
    }

    public String getOpening_stock_backroom() {
        return opening_stock_backroom;
    }

    public void setOpening_stock_backroom(String opening_stock_backroom) {
    ...
    public String getSumofSTOCK() {
        return sumofSTOCK;
    }

    public void setSumofSTOCK(String sumofSTOCK) {
        this.sumofSTOCK = sumofSTOCK;
    }

    String sumofSTOCK="";

    public String getSumofChillERSTOCK() {
        return sumofChillERSTOCK;
    }

    public void setSumofChillERSTOCK(String sumofChillERSTOCK) {
        this.sumofChillERSTOCK = sumofChillERSTOCK;
    }

    String sumofChillERSTOCK="";
}
