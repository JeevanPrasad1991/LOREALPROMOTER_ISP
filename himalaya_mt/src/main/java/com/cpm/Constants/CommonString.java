...
public static final String TABLE_INSERT_HEADER_FOOD_STORE_DATA = "openingHeader_FOOD_STORE_data";
	...
	public static final String CREATE_TABLE_FACING_COMPETITOR_DATA = "CREATE TABLE IF NOT EXISTS FACING_COMPETITOR_DATA(KEY_ID INTEGER PRIMARY KEY AUTOINCREMENT, STORE_CD INTEGER, CATEGORY_CD INTEGER, CATEGORY VARCHAR, BRAND VARCHAR, BRAND_CD INTEGER, FACING INTEGER )";
	
	public static final String TABLE_STOCK_DATA="STOCK_DATA";
	public static final String CREATE_TABLE_STOCK_DATA = "CREATE TABLE IF NOT EXISTS STOCK_DATA(Common_Id INTEGER, SKU_CD INTEGER,SKU VARCHAR, BRAND_CD INTEGER, BRAND VARCHAR, STORE_CD INTEGER, OPENING_TOTAL_STOCK INTEGER, FACING INTEGER, STOCK_UNDER_DAYS VARCHAR, MIDDAY_TOTAL_STOCK INTEGER, CLOSING_STOCK INTEGER)";
	...
	//public static final String URL = "http://mi.retailtrac.in//MondelezIndia.asmx";

	//public static final String URL_Notice_Board = "http://mi.retailtrac.in//notice/notice.html";
