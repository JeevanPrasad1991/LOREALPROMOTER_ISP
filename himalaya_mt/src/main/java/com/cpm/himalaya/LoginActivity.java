...
//				database.open();
                ...
                /*	intent = new Intent(getBaseContext(),ShowUpdateActivity.class);*/
                    ...
                    /*if (questionGetterSetter.getAnswer_cd().size() > 0
                            && questionGetterSetter.getStatus().get(0).equals("N")
                        ...
                        //Dailog Dismiss After 20 Seconds
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                answerData.setAnswer_id("0");
                                answerData.setRight_answer("");
        ...
        protected String doInBackground(AnswerData... params) {
            try {
                ...
                String userauth_xml =
                        "[DATA]"
                                + "[TODAY_ANSWER]"
                                + "[USER_ID]" + answerData.getUsername() + "[/USER_ID]"
                                + "[QUESTION_ID]" + answerData.getQuestion_id() + "[/QUESTION_ID]"
                                + "[VISIT_DATE]" + answerData.getVisit_date() + "[/VISIT_DATE]"
                                + "[ANSWER_ID]" + answerData.getAnswer_id() + "[/ANSWER_ID]"
                                + "[/TODAY_ANSWER]"
                                + "[/DATA]";
